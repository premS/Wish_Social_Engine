   ...
   <div id="page-title">
      ...
      <div class="row">
         ...
         <div class="ten columns centered text-center">
            <h1>Achieved<span>.</span></h1>
            <p>How did you fulfill your dream </p>
         </div>
...
document.all.value1.value = value;
  	...
  	<form name ="form" action="updateWish.do?id=${wish.getMwid()}" method="POST" >
		...
		<tr><td colspan="4" style="align:center"><a href="updateWish.do?id=${wish.getMwid()}"><button class="tablebutton">Fulfill the Wish</button></a></td></tr>
		</table>
